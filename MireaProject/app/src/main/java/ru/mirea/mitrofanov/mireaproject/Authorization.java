...
import ru.mirea.mitrofanov.mireaproject.databinding.AuthorizationBinding;
...
// Re-enable button
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(Authorization.this, "Verification email sent to " + user.getEmail(), Toast.LENGTH_SHORT).show();
                } else {
                    Log.e(TAG, "sendEmailVerification", task.getException());
                    Toast.makeText(Authorization.this, "Failed to send verification email.", Toast.LENGTH_SHORT).show();
                }
// [END_EXCLUDE]
            }
        });
